...
import { useDeleteCouponMutation, useUpdateCouponMutation } from "@/tanstack/coupon";
  ...
  return (
    <Modal visible={visible} animationType="slide">
      <ScrollView contentContainerStyle={styles.container}>
        <Text style={styles.title}>Chỉnh sửa coupon</Text>
        <TextInput
          style={styles.input}
          placeholder="Code"
          value={form.code}
        ...
        <TextInput
          ...
          onChangeText={(val) => setForm({ ...form, value: Number(val) })}
        />
        <TextInput
          style={styles.input}
        ...
        <View style={styles.row}>
          ...
          <TouchableOpacity
            onPress={() => setForm({ ...form, isUsed: !form.isUsed })}
          >
            <Text style={styles.toggle}>
              {form.isUsed ? "✅ Đã dùng" : "❌ Chưa"}
            </Text>
          </TouchableOpacity>
        </View>
